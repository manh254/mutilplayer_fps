...
public class SingleShotGun : Gun
{
    ...
    public void zoomIn()
    {
        ...
        transform.parent.localPosition = Vector3.Lerp(Vector3.zero, new Vector3(0f, -0.37f, 0.54f), tempTime / zoomInTime);
        transform.parent.localScale = Vector3.Lerp(Vector3.one, new Vector3(2.5f, 2.5f, 2.5f), tempTime / zoomInTime);
