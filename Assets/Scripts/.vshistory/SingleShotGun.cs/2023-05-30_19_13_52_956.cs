...
public class SingleShotGun : Gun
{
    ...
    public void ZoomOut()
    {
        transform.localPosition = Vector3.Lerp(Vector3.zero, new Vector3(-0.275f, 0.1f, -0.41f), tempTime / zoomInTime);
        transform.localScale = Vector3.Lerp(Vector3.one, new Vector3(1.55f, 1.55f, 1.55f), tempTime / zoomInTime);
        tempTime -= Time.deltaTime;
    }
    public void ZoomIn()
    {
        
        transform.parent.localPosition = Vector3.Lerp(Vector3.zero, new Vector3(-0.275f, 0.1f, -0.41f), tempTime / zoomInTime);
        transform.parent.localScale = Vector3.Lerp(Vector3.one, new Vector3(1.55f, 1.55f, 1.55f), tempTime / zoomInTime);
        tempTime += Time.deltaTime;
    }
