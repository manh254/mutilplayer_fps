...
public class SingleShotGun : Gun
{
    ...
    public void ZoomOut()
    {
        ...
        tempTime = Mathf.Clamp(tempTime, 0f, 0.5f);
    }
    public void ZoomIn()
    {
        
        transform.localPosition = Vector3.Lerp(Vector3.zero, new Vector3(-0.275f, 0.1f, -0.41f), Mathf.Clamp(tempTime / zoomInTime, 0f, 1f));
        transform.localScale = Vector3.Lerp(Vector3.one, new Vector3(1.55f, 1.55f, 1.55f), Mathf.Clamp(tempTime / zoomInTime, 0f, 1));
        tempTime += Time.deltaTime;
        tempTime = Mathf.Clamp(tempTime, 0f, 0.5f);
    }
